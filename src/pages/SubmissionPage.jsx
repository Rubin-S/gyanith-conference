...
const StepCard = ({ number, title, desc, icon, action, isLast }) => (
  <motion.div
    variants={fadeUp}
    className="relative flex gap-6 md:gap-10 pb-16 last:pb-0 group"
  >
    {/* Timeline Line */}
    {!isLast && (
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          >
            <div className="inline-flex items-center gap-2 py-2 px-4 rounded-full border border-yellow-500/30 bg-yellow-500/10 backdrop-blur-md mb-6 text-yellow-400 text-xs font-bold tracking-widest uppercase">
              <MdPublishedWithChanges className="text-lg" /> Journey to
              Publication
            </div>
            ...
            <p className="max-w-2xl mx-auto text-lg md:text-xl text-indigo-100 font-light leading-relaxed">
              A streamlined four-step process to share your research.{" "}
          ...
          <div className="flex gap-4 items-start">
            ...
            <div>
              <h4 className="font-bold text-slate-900 mb-2">
                Prerequisite for Extended Abstracts
              </h4>
              <p className="text-slate-600 text-sm leading-relaxed">
                <strong>Extended Abstract Submission</strong> is strictly
                restricted to authors with accepted initial abstracts. You will
                require your unique <strong>Paper ID</strong> (sent via email)
                to proceed. Unsolicited submissions without an ID will not be
                processed.
              </p>
            </div>
          </div>
      ...
      <div className="bg-slate-50 border-t border-slate-200 py-16">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-slate-500 mb-6">
            If you encounter issues during the submission process, please
